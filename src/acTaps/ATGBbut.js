...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-ATGBbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <ATGBbut value={value} index={0}>
      <ATGBcom/>
      </ATGBbut>
      <ATGBbut value={value} index={2}>
        <ATGAcom/>
      </ATGBbut>
      <ATGBbut value={value} index={3}>
        <ATGBcom/>
      </ATGBbut>
      <ATGBbut value={value} index={4}>
      <ATGccom/>
      </ATGBbut>
      <ATGBbut value={value} index={5}>
       <ATGDcom/>
      </ATGBbut>
      <ATGBbut value={value} index={6}>
        <ATGEcom/>
      </ATGBbut>
