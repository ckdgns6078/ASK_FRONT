...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-ATGAbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <ATGAbut value={value} index={0}>
        <ATGAcom/>
      </ATGAbut>
      <ATGAbut value={value} index={2}>
        <ATGAcom/>
      </ATGAbut>
      <ATGAbut value={value} index={3}>
        <ATGBcom/>
      </ATGAbut>
      <ATGAbut value={value} index={4}>
      <ATGccom/>
      </ATGAbut>
      <ATGAbut value={value} index={5}>
       <ATGDcom/>
      </ATGAbut>
      <ATGAbut value={value} index={6}>
        <ATGEcom/>
      </ATGAbut>
