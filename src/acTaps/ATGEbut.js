...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-ATGEbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <ATGEbut value={value} index={0}>
         <ATGEcom/>
      </ATGEbut>
      <ATGEbut value={value} index={2}>
        <ATGAcom/>
      </ATGEbut>
      <ATGEbut value={value} index={3}>
        <ATGBcom/>
      </ATGEbut>
      <ATGEbut value={value} index={4}>
      <ATGccom/>
      </ATGEbut>
      <ATGEbut value={value} index={5}>
       <ATGDcom/>
      </ATGEbut>
      <ATGEbut value={value} index={6}>
        <ATGEcom/>
      </ATGEbut>
