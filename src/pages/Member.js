...
const Member = () => {
    ...
    return (
       ...
       <h5  style={{position:'absolute' ,top:'165px'}}><strong>아이디</strong>  
         <Button   onClick={checkId} size="sm"  style={{position:'absolute',left:'293px',height:'30px',top:'-5px' ,backgroundColor:'#2F58B8',  color: '#fff' ,width:'100px'}}>
       중복 확인
        </Button></h5>
          ...
          <TextField
            ...
            <br/>
             ...
             <h5 style={{position:'absolute' ,top:'295px'}}><strong>이름 또는 기업명</strong>
             </h5> 
            <TextField
            ...
            <h5 style={{position:'absolute' ,top:'400px'}}><strong>비밀번호</strong>
             </h5> 
            ...
            <h5 style={{position:'absolute' ,top:'530px'}}><strong>비밀번호 확인</strong>  </h5> 
            <TextField
            ...
            <h5 style={{position:'absolute' ,top:'650px'}}><strong>이메일 주소</strong>  </h5> 
            <TextField
