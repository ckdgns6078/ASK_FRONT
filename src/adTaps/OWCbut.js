...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-OWCbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <OWCbut value={value} index={0}>
        <OWDcom/>
      </OWCbut>
      <OWCbut value={value} index={1}>
      <OWAcom/>
      </OWCbut>
      <OWCbut value={value} index={2}>
      <OWAcom/>
      </OWCbut>
      <OWCbut value={value} index={3}>
        <OWBcom/>
      </OWCbut>
      {/* <OWCbut value={value} index={4}>
        <OWCcom/>
      </OWCbut> */}
      <OWCbut value={value} index={4}>
        <OWDcom/>
