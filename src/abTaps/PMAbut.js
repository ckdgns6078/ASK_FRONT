...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-PMAbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <PMAbut value={value} index={0}>
      <PMAcom/>
      </PMAbut>
      <PMAbut value={value} index={1}>
      <PMAcom/>
      </PMAbut>
      <PMAbut value={value} index={2}>
        <PMBcom/>
      </PMAbut>
      <PMAbut value={value} index={3}>
       <PMCcom/>
      </PMAbut>
      <PMAbut value={value} index={4}>
       <PMDcom/>
      </PMAbut>
