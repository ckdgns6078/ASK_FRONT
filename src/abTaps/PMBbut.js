...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-PMBbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <PMBbut value={value} index={0}>
      <PMBcom/>
      </PMBbut>
      <PMBbut value={value} index={1}>
      <PMAcom/>
      </PMBbut>
      <PMBbut value={value} index={2}>
        <PMBcom/>
      </PMBbut>
      <PMBbut value={value} index={3}>
       <PMCcom/>
      </PMBbut>
      <PMBbut value={value} index={4}>
       <PMDcom/>
      </PMBbut>
