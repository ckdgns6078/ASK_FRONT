...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-PMDbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <PMDbut value={value} index={0}>
      <PMDcom/>
      </PMDbut>
      <PMDbut value={value} index={1}>
      <PMAcom/>
      </PMDbut>
      <PMDbut value={value} index={2}>
        <PMBcom/>
      </PMDbut>
      <PMDbut value={value} index={3}>
       <PMCcom/>
      </PMDbut>
      <PMDbut value={value} index={4}>
       <PMDcom/>
      </PMDbut>
