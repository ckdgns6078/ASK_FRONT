...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-BAAbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <BAAbut value={value} index={0}>
       <BAPAcom/>
      </BAAbut>
    
      <BAAbut value={value} index={2}>
      <BAPAcom/>
      </BAAbut>
      <BAAbut value={value} index={3}>
       <BAPBcom/>
      </BAAbut>
      {/* <BAAbut value={value} index={4}>
        <BKPCcom/>
      </BAAbut> */}
      <BAAbut value={value} index={4}>
      <BKPDcom/>
