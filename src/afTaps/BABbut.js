...
function a11yProps(index) {
  return {
    ...
    'aria-controls': `vertical-BABbut-${index}`,
  };
}
...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      ...
      <BABbut value={value} index={0}>
      <BAPBcom/>
      </BABbut>
    
      <BABbut value={value} index={2}>
      <BAPAcom/>
      </BABbut>
      <BABbut value={value} index={3}>
       <BAPBcom/>
      </BABbut>
      {/* <BABbut value={value} index={4}>
        <BKPCcom/>
      </BABbut> */}
      <BABbut value={value} index={4}>
      <BKPDcom/>
