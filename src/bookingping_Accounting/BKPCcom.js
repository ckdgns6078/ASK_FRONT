...
const BKPCcom = () => {
    ...
    const closeAddData = () => {
     ...
     const [checkedItems, setCheckedItems] = useState(new Set());
        ...
        //한명 출력용
        const printBtn = () =>{
            window.open('http://localhost:3000/Tax?id='+modifyData.payStatementId);
        }
    ...
    return (
        <div style={{ width: '1400px', position: 'relative' }}>
            ...
            <br />
            <div>
                <button style={{ position: 'absolute', right: "0px", top: '70px' }} onClick={handleShow} className="Atmp1"><strong>추가</strong></button>
                <button style={{ position: 'absolute',  right: "90px", top: '70px' }} onClick={printCheck} className="Atmp1">  <strong>출력</strong></button>
            </div>
