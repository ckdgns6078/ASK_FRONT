...
const ATGccom = () => {
    ...
    const handleShow = (e) => {
        ...
        axios.post('http://192.168.2.82:5000/modaldetail_Vactlist', {
            ...
            let get = new Date(response.data[0].vactStartDate);
            if (get < today) {
                setDateCheck(true);
            }
            console.log("get", get);
        ...
        // let getDate = new Date(addData.vactStartDate);
        // console.log(addData);
        // console.log("getDate " , getDate);
        // console.log("date" , today);
        // if(getDate < today){
        //     console.log("date가 더 큽니다.");
        // }
        setShow(true);
    }
    //수정
    ...
    return (
        <div style={{ width: '1400px', position: 'relative' }}>
            ...
            <Modal
                ...
                <Modal.Footer>
                    {dateCheck && <h4 style={{ color: 'red', fontSize: '18px' }}><strong>이미 지난 날짜의 휴가는 승인/미승인 처리할 수 없습니다.</strong></h4>}
