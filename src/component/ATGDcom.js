    ...
    return (
        <div style={{ width: '1400px', position: 'relative' }}>
            ...
            <div>
                ...
                <button style={{ position: 'absolute', left: "110px", top: '550px' }} onClick={MdShow} className="Atmp1">  <strong>추가</strong></button>
                <button style={{ position: 'absolute', left: "0px", top: '550px' }} onClick={DeShow} className="Atmp1"> <strong>저장</strong> </button>
